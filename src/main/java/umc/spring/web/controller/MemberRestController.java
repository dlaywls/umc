...
public class MemberRestController {
    ...
    public ApiResponse<MemberResponseDTO.ReviewPreViewListDTO> getReviewList(@RequestParam(name = "memberId") Long memberId, @CheckPage @RequestParam(name = "page") Integer page){
