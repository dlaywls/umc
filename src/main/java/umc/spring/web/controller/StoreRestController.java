...
import static umc.spring.converter.StoreConverter.missionPreViewListDTO;
...
public class StoreRestController {
    ...
    public ResponseDto<StoreResponseDTO.MissionPreViewListDTO> getMissionList(@PathVariable(name = "storeId") Long storeId, @RequestParam(name = "page") Integer page){
        Page<Mission> missionPage=storeQueryService.getMissionList(storeId,page);
        StoreResponseDTO.MissionPreViewListDTO missionListDTO =missionPreViewListDTO(missionPage);
